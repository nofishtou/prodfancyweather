...
export default class App {
  ...
  changeBackground() {
    console.log('background fetch', `https://api.unsplash.com/photos/random?orientation=landscape&per_page=1&client_id=${this.tokens.unsplashToken}&query={nature,${this.getSeason()},${this.getDayTime()}}`);
